...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen bg-white text-gray-800 space-y-16 py-12 md:px-16">
      {/* Header Features */}
      ...
      {/* How It Works */}
      <section className="bg-pink-100 md:px-10 py-10 px-6 w-full rounded-lg space-y-6">
        ...
        <div className="grid md:grid-cols-2 p-2">
          {howItWorks.map((step, index) => (
            <div key={index} className="bg-white flex flex-row relative">
              ...
              <div className="absolute right-0 max-md:-right-7 top-10 ">
                <Image
                  src={step.step}
                  alt={`Step ${index + 1}`}
